...
export const propertyCreateSchema = z.object({
    ...
    homepageStatus: z.string().optional().nullable(),

    // Dynamic page content (JSON)
    investmentOverview: z.unknown().optional().nullable(),
    expectedROI: z.string().optional().nullable(),
    investmentBenefits: z.unknown().optional().nullable(),
    locationAdvantages: z.unknown().optional().nullable(),
    testimonials: z.unknown().optional().nullable(),
    faqs: z.unknown().optional().nullable(),
    siteVisitBenefits: z.unknown().optional().nullable(),
    contactInformation: z.unknown().optional().nullable(),
    footerInformation: z.unknown().optional().nullable(),
